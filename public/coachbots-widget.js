...
async function submitEmailAndName() {
    ...
    await fetch(
        ...
        .then((data) => {
            ...
            messageText.innerHTML = `It's showtime ✨, here is your detailed <a target="_blank" style="color: #3b82f6;text-decoration:none;" href="${globalReportUrl}">feedback report</a>. The feedback is also emailed to you and will be available to you for 60 days.`;
            ...
            try {
                if (body instanceof FormData) {
                    ...
                    if (userAcessAvailability === "Yes") {
                        ...
                        signals.onResponse({
                            text: "We are working on a version that understands your command to create simulations. Meanwhile, please contact your administrator. Thank you!",
                        });
                        return;
                    }
