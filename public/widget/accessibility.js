...
document.addEventListener("DOMContentLoaded", function () {
  function e() {
    r.classList.toggle("close"),
      (a.innerHTML = r.classList.contains("close")
        ? '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-universal-access-circle" viewBox="0 0 16 16">\n  <path d="M8 4.143A1.071 1.071 0 1 0 8 2a1.071 1.071 0 0 0 0 2.143m-4.668 1.47 3.24.316v2.5l-.323 4.585A.383.383 0 0 0 7 13.14l.826-4.017c.045-.18.301-.18.346 0L9 13.139a.383.383 0 0 0 .752-.125L9.43 8.43v-2.5l3.239-.316a.38.38 0 0 0-.047-.756H3.379a.38.38 0 0 0-.047.756Z"/>\n  <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0M1 8a7 7 0 1 1 14 0A7 7 0 0 1 1 8"/>\n</svg>'
  ...
  function s() {
    localStorage.setItem(
      ...
      JSON.stringify({
        invertColors: i.classList.contains("invert"),
        grayscale: i.classList.contains("grayscale"),
        highSaturation: i.classList.contains("high-saturation"),
        lowSaturation: i.classList.contains("low-saturation"),
        underlineStyle0: i.classList.contains("underline-style-0"),
        underlineStyle1: i.classList.contains("underline-style-1"),
        underlineStyle2: i.classList.contains("underline-style-2"),
        fontSize: i.style.fontSize,
        lineHeight0: i.classList.contains("line-height-0"),
        lineHeight1: i.classList.contains("line-height-1"),
        lineHeight2: i.classList.contains("line-height-2"),
        letterSpacing: i.style.letterSpacing,
        textAlign: i.style.textAlign,
        contrast: i.classList.contains("contrast"),
        contrastStyle0: i.classList.contains("contrast-style-0"),
        contrastStyle1: i.classList.contains("contrast-style-1"),
        contrastStyle2: i.classList.contains("contrast-style-2"),
        hideImages: i.classList.contains("hide-images"),
        hideVideo: i.classList.contains("hide-video"),
        cursor0: S.classList.contains("cursor-0"),
        cursor1: S.classList.contains("cursor-1"),
        cursor2: S.classList.contains("cursor-2"),
        accPosition: r.classList.contains("left")
          ? "left"
          : r.classList.contains("top")
          ? "top"
          : r.classList.contains("bottom")
  ...
  (c.innerHTML = accessibilityMenuStyles),
    document.head.appendChild(c),
    document.body.insertAdjacentHTML("beforeend", accessibilityMenuHTML);
  const r = document.getElementById("accessibility-modal"),
    a = document.getElementById("closeBtn");
  document.getElementById("accessibility-tools");
  a.addEventListener("click", () => {
    e();
  });
  const n = document.querySelectorAll(".acc-item");
  n.forEach((e) => {
    e.addEventListener("click", () => {
      e.querySelector(".acc-child").classList.toggle("active"),
  ...
  const i = document.querySelector("html"),
    l = document.getElementById("align-acc-left"),
    o = document.getElementById("align-acc-top"),
    d = document.getElementById("align-acc-bottom"),
    v = document.getElementById("align-acc-right");
  t(),
    ...
    document.querySelector("#invert-colors").addEventListener("click", () => {
      document.querySelector("#invert-colors");
      i.classList.toggle("invert");
    }),
    document.querySelector("#grayscale").addEventListener("click", () => {
      document.querySelector("#grayscale");
      i.classList.toggle("grayscale");
    });
  let h = 0;
  document.querySelector("#saturation").addEventListener("click", () => {
    const e = document.querySelector("#saturation");
    2 === h
      ? ((h = 0),
        (e.querySelector("p").innerText = "Low Saturation"),
        e.querySelector(".acc-progress-parent").classList.add("hiddenn"),
        e.classList.add("active"),
        i.classList.remove("high-saturation"),
        i.classList.remove("low-saturation"))
      : (e.classList.remove("active"),
        0 === h
          ? (i.classList.add("low-saturation"),
            (e.querySelector("p").innerText = "Low Saturation"),
            e.querySelector(".acc-progress-parent").classList.remove("hiddenn"),
            e.querySelector(".acc-progress-child-1").classList.add("active"),
            e.querySelector(".acc-progress-child-2").classList.remove("active"))
          : 1 === h &&
            (i.classList.remove("low-saturation"),
            i.classList.add("high-saturation"),
            (e.querySelector("p").innerText = "High Saturation"),
            e.querySelector(".acc-progress-parent").classList.remove("hiddenn"),
            e.querySelector(".acc-progress-child-1").classList.remove("active"),
            e.querySelector(".acc-progress-child-2").classList.add("active")),
        h++);
  });
  let g = 0;
  document.querySelector("#underline").addEventListener("click", () => {
    ...
    3 === g
      ? ((g = 0),
        e.querySelector(".acc-progress-parent").classList.add("hiddenn"),
        e.classList.add("active"),
        i.classList.remove("underline"),
        i.classList.remove("underline-style-0"),
        i.classList.remove("underline-style-1"),
        i.classList.remove("underline-style-2"))
      : (e.classList.remove("active"),
        0 === g
          ? (i.classList.add("underline"),
            ...
            e.querySelector(".acc-progress-child-1").classList.add("active"),
            e.querySelector(".acc-progress-child-2").classList.remove("active"),
            e.querySelector(".acc-progress-child-3").classList.remove("active"),
            i.classList.add("underline-style-0"),
            i.classList.remove("underline-style-1"),
            i.classList.remove("underline-style-2"))
          : 1 === g
          ? (i.classList.remove("underline-style-0"),
            i.classList.add("underline-style-1"),
            i.classList.remove("underline-style-2"),
            e.querySelector(".acc-progress-parent").classList.remove("hiddenn"),
            e.querySelector(".acc-progress-child-1").classList.remove("active"),
            e.querySelector(".acc-progress-child-2").classList.add("active"),
          ...
          : 2 === g &&
            (i.classList.remove("underline-style-0"),
            i.classList.remove("underline-style-1"),
            i.classList.add("underline-style-2"),
            e.querySelector(".acc-progress-parent").classList.remove("hiddenn"),
            e.querySelector(".acc-progress-child-1").classList.remove("active"),
            e.querySelector(".acc-progress-child-2").classList.remove("active"),
            e.querySelector(".acc-progress-child-3").classList.add("active")),
        g++);
  });
  let u = 0;
  document.querySelector("#font-size").addEventListener("click", () => {
    const e = document.querySelector("#font-size");
    3 === u
      ? ((u = 0),
        e.querySelector(".acc-progress-parent").classList.add("hiddenn"),
        e.classList.add("active"),
  ...
  document.querySelector("#line-height").addEventListener("click", () => {
    const e = document.querySelector("#line-height");
    3 === y
      ? ((y = 0),
        e.querySelector(".acc-progress-parent").classList.add("hiddenn"),
        e.classList.add("active"),
        i.classList.remove("line-height-0"),
        i.classList.remove("line-height-1"),
        i.classList.remove("line-height-2"))
      : (e.classList.remove("active"),
        0 === y
          ? (i.classList.add("line-height-0"),
            i.classList.remove("line-height-1"),
            i.classList.remove("line-height-2"),
            e.querySelector(".acc-progress-parent").classList.remove("hiddenn"),
            e.querySelector(".acc-progress-child-1").classList.add("active"),
  ...
  document.querySelector("#letter-spacing").addEventListener("click", () => {
    const e = document.querySelector("#letter-spacing");
    3 === p
      ? ((p = 0),
        e.querySelector(".acc-progress-parent").classList.add("hiddenn"),
        e.classList.add("active"),
  ...
  document.querySelector("#text-align").addEventListener("click", () => {
    const e = document.querySelector("#text-align");
    3 === L
      ? ((L = 0),
        e.querySelector(".acc-progress-parent").classList.add("hiddenn"),
        e.classList.add("active"),
      ...
      : (e.classList.remove("active"),
        0 === L
          ? ((i.style.textAlign = "left"),
            (e.parentElement.querySelector("svg").innerHTML =
              '<path d="M4.5 7C4.22386 7 4 6.77614 4 6.5C4 6.22386 4.22386 6 4.5 6H19.5C19.7761 6 20 6.22386 20 6.5C20 6.77614 19.7761 7 19.5 7H4.5ZM4.5 15C4.22386 15 4 14.7761 4 14.5C4 14.2239 4.22386 14 4.5 14H19.5C19.7761 14 20 14.2239 20 14.5C20 14.7761 19.7761 15 19.5 15H4.5ZM4.5 11C4.22386 11 4 10.7761 4 10.5C4 10.2239 4.22386 10 4.5 10H13.5C13.7761 10 14 10.2239 14 10.5C14 10.7761 13.7761 11 13.5 11H4.5ZM4.5 19C4.22386 19 4 18.7761 4 18.5C4 18.2239 4.22386 18 4.5 18H13.5C13.7761 18 14 18.2239 14 18.5C14 18.7761 13.7761 19 13.5 19H4.5Z" fill="black"/>'),
            e.querySelector(".acc-progress-parent").classList.remove("hiddenn"),
            e.querySelector(".acc-progress-child-1").classList.add("active"),
            e.querySelector(".acc-progress-child-2").classList.remove("active"),
  ...
  document.querySelector("#contrast").addEventListener("click", () => {
    const e = document.querySelector("#contrast");
    3 === m
      ? ((m = 0),
        e.querySelector(".acc-progress-parent").classList.add("hiddenn"),
        e.classList.add("active"),
        i.classList.remove("contrast"),
        i.classList.remove("contrast-style-0"),
        i.classList.remove("contrast-style-1"),
        i.classList.remove("contrast-style-2"))
      : (e.classList.remove("active"),
        0 === m
          ? (i.classList.add("contrast"),
            e.querySelector(".acc-progress-parent").classList.remove("hiddenn"),
            e.querySelector(".acc-progress-child-1").classList.add("active"),
            e.querySelector(".acc-progress-child-2").classList.remove("active"),
            e.querySelector(".acc-progress-child-3").classList.remove("active"),
            i.classList.add("contrast-style-0"),
            i.classList.remove("contrast-style-1"),
            i.classList.remove("contrast-style-2"))
          : 1 === m
          ? (i.classList.remove("contrast-style-0"),
            i.classList.add("contrast-style-1"),
            i.classList.remove("contrast-style-2"),
            e.querySelector(".acc-progress-parent").classList.remove("hiddenn"),
            e.querySelector(".acc-progress-child-1").classList.remove("active"),
            e.querySelector(".acc-progress-child-2").classList.add("active"),
          ...
          : 2 === m &&
            (i.classList.remove("contrast-style-0"),
            i.classList.remove("contrast-style-1"),
            i.classList.add("contrast-style-2"),
            e.querySelector(".acc-progress-parent").classList.remove("hiddenn"),
            e.querySelector(".acc-progress-child-1").classList.remove("active"),
            e.querySelector(".acc-progress-child-2").classList.remove("active"),
            e.querySelector(".acc-progress-child-3").classList.add("active")),
    ...
    document.querySelector("#hide-images").addEventListener("click", () => {
      i.classList.toggle("hide-images");
    }),
    document.querySelector("#hide-video").addEventListener("click", () => {
      i.classList.toggle("hide-video");
    });
  let f = 0;
  document.querySelector("#change-cursor").addEventListener("click", () => {
    const e = document.querySelector("#change-cursor"),
      t = document.querySelector("#cursor"),
      s = document.getElementById("triangle-cursor");
    s && (s.style.display = "none"),
      3 === f
        ? ((f = 0),
          e.querySelector(".acc-progress-parent").classList.add("hiddenn"),
          e.classList.add("active"),
          t.classList.remove("cursor-0"),
          t.classList.remove("cursor-1"),
          t.classList.remove("cursor-2"),
          (i.style.cursor = ""))
        : (e.classList.remove("active"),
          0 === f
            ? (t.classList.add("cursor-0"),
              t.classList.remove("cursor-1"),
              t.classList.remove("cursor-2"),
              e
                .querySelector(".acc-progress-parent")
                .classList.remove("hiddenn"),
              e.querySelector(".acc-progress-child-1").classList.add("active"),
              e
                .querySelector(".acc-progress-child-2")
                .classList.remove("active"),
              e
                .querySelector(".acc-progress-child-3")
                .classList.remove("active"),
              (t.style.width = "50px"),
              (t.style.height = "50px"))
            : 1 === f
            ? (t.classList.remove("cursor-0"),
              t.classList.add("cursor-1"),
              t.classList.remove("cursor-2"),
              e
                .querySelector(".acc-progress-parent")
                .classList.remove("hiddenn"),
              e
                .querySelector(".acc-progress-child-1")
                .classList.remove("active"),
              e.querySelector(".acc-progress-child-2").classList.add("active"),
              e
                .querySelector(".acc-progress-child-3")
  ...
  document.addEventListener("mousemove", (e) => {
    if (S.classList.contains("cursor-0"))
      (S.style.top = e.clientY + "px"), (S.style.left = e.clientX + "px");
    else if (S.classList.contains("cursor-1"))
      (S.style.top = e.clientY + "px"), (S.style.left = 0);
    else if (S.classList.contains("cursor-2")) {
      (S.style.top = e.clientY + "px"),
        e.clientX < window.innerWidth / 8
          ? (S.style.left = window.innerWidth / 8 + "px")
          : e.clientX > window.innerWidth - window.innerWidth / 8
          ? (S.style.left = window.innerWidth - window.innerWidth / 8 + "px")
          : (S.style.left = e.clientX + "px");
      const t = document.getElementById("triangle-cursor");
      (t.style.top = e.clientY + "px"), (t.style.left = e.clientX + "px");
    }
  }),
    document.querySelectorAll("a,button").forEach((e) => {
      e.addEventListener("mouseover", () => {
        S.classList.contains("cursor-0") &&
    ...
    document.querySelector("#reset-all").addEventListener("click", () => {
      ...
      i.classList.remove("invert"),
        ...
        i.classList.remove("contrast-style-1"),
        i.classList.remove("contrast-style-2"),
        i.classList.remove("hide-images"),
        i.classList.remove("hide-video"),
        e.classList.remove("cursor-0"),
        e.classList.remove("cursor-1"),
        e.classList.remove("cursor-2"),
        (i.style.cursor = "");
      const t = document.getElementById("triangle-cursor");
      t && (t.style.display = "none"),
        document.querySelectorAll(".acc-progress-parent").forEach((e) => {
          e.classList.add("hiddenn");
        }),
        document.querySelectorAll(".acc-child").forEach((e) => {
          e.classList.remove("active"),
            e.querySelectorAll("path").forEach((e) => {
              e.style.fill = "var(--acc_color_1)";
            });
        }),
        (h = 0),
        (g = 0),
  ...
  const w = JSON.parse(localStorage.getItem("accessibility-settings"));
  if (
    (w &&
      (w.invertColors && i.classList.add("invert"),
      w.grayscale && i.classList.add("grayscale"),
      w.highSaturation && i.classList.add("high-saturation"),
      w.lowSaturation && i.classList.add("low-saturation"),
      w.underlineStyle0 && i.classList.add("underline-style-0"),
      w.underlineStyle1 && i.classList.add("underline-style-1"),
      w.underlineStyle2 && i.classList.add("underline-style-2"),
      w.fontSize && (i.style.fontSize = w.fontSize),
      w.lineHeight0 && i.classList.add("line-height-0"),
      w.lineHeight1 && i.classList.add("line-height-1"),
      w.lineHeight2 && i.classList.add("line-height-2"),
      w.letterSpacing && (i.style.letterSpacing = w.letterSpacing),
      w.textAlign && (i.style.textAlign = w.textAlign),
      w.contrast && i.classList.add("contrast"),
      w.contrastStyle0 && i.classList.add("contrast-style-0"),
      w.contrastStyle1 && i.classList.add("contrast-style-1"),
      w.contrastStyle2 && i.classList.add("contrast-style-2"),
      w.hideImages && i.classList.add("hide-images"),
      w.hideVideo && i.classList.add("hide-video"),
      w.cursor0 && S.classList.add("cursor-0"),
      w.cursor1 && S.classList.add("cursor-1"),
      w.cursor2 && S.classList.add("cursor-2"),
      r.classList.contains("left")
        ? r.classList.remove("left")
        : r.classList.contains("top")
        ? r.classList.remove("top")
        : r.classList.contains("bottom")
        ? r.classList.remove("bottom")
        : r.classList.contains("right") && r.classList.remove("right"),
      "left" === w.accPosition
        ? r.classList.add("left")
        : "top" === w.accPosition
        ? r.classList.add("top")
        : "bottom" === w.accPosition
        ? r.classList.add("bottom")
        : "right" === w.accPosition && r.classList.add("right"),
      t()),
    i.classList.contains("invert") &&
      document.querySelector("#invert-colors").classList.add("active"),
    i.classList.contains("grayscale") &&
      document.querySelector("#grayscale").classList.add("active"),
    i.classList.contains("high-saturation") ||
      i.classList.contains("low-saturation"))
  ) {
    const e = document.querySelector("#saturation");
    e.classList.add("active"),
      e.querySelector(".acc-progress-parent").classList.remove("hiddenn"),
  ...
  if (
    i.classList.contains("underline-style-0") ||
    i.classList.contains("underline-style-1") ||
    i.classList.contains("underline-style-2")
  ) {
    const e = document.querySelector("#underline");
    e.classList.add("active"),
      e.querySelector(".acc-progress-parent").classList.remove("hiddenn"),
  ...
  if (i.style.fontSize) {
    ...
    e.classList.add("active"),
      e.querySelector(".acc-progress-parent").classList.remove("hiddenn"),
      "1.3rem" === i.style.fontSize
        ? (e.querySelector(".acc-progress-child-1").classList.add("active"),
          e.querySelector(".acc-progress-child-2").classList.remove("active"),
          e.querySelector(".acc-progress-child-3").classList.remove("active"))
        : "1.5rem" === i.style.fontSize
        ? (e.querySelector(".acc-progress-child-1").classList.remove("active"),
          e.querySelector(".acc-progress-child-2").classList.add("active"),
          e.querySelector(".acc-progress-child-3").classList.remove("active"))
        : "1.8rem" === i.style.fontSize &&
          (e.querySelector(".acc-progress-child-1").classList.remove("active"),
          e.querySelector(".acc-progress-child-2").classList.remove("active"),
          e.querySelector(".acc-progress-child-3").classList.add("active"));
  }
  if (
    i.classList.contains("line-height-0") ||
    i.classList.contains("line-height-1") ||
    i.classList.contains("line-height-2")
  ) {
    const e = document.querySelector("#line-height");
    e.classList.add("active"),
      e.querySelector(".acc-progress-parent").classList.remove("hiddenn"),
  ...
  if (i.style.letterSpacing) {
    const e = document.querySelector("#letter-spacing");
    e.classList.add("active"),
      e.querySelector(".acc-progress-parent").classList.remove("hiddenn"),
      "0.1rem" === i.style.letterSpacing
        ? (e.querySelector(".acc-progress-child-1").classList.add("active"),
          e.querySelector(".acc-progress-child-2").classList.remove("active"),
          e.querySelector(".acc-progress-child-3").classList.remove("active"))
        : "0.2rem" === i.style.letterSpacing
        ? (e.querySelector(".acc-progress-child-1").classList.remove("active"),
          e.querySelector(".acc-progress-child-2").classList.add("active"),
          e.querySelector(".acc-progress-child-3").classList.remove("active"))
        : "0.3rem" === i.style.letterSpacing &&
          (e.querySelector(".acc-progress-child-1").classList.remove("active"),
          e.querySelector(".acc-progress-child-2").classList.remove("active"),
          e.querySelector(".acc-progress-child-3").classList.add("active"));
  }
    ...
    e.classList.add("active"),
      ...
      "left" === i.style.textAlign
        ? (e.querySelector(".acc-progress-child-1").classList.add("active"),
          e.querySelector(".acc-progress-child-2").classList.remove("active"),
          e.querySelector(".acc-progress-child-3").classList.remove("active"))
        : "center" === i.style.textAlign
        ? (e.querySelector(".acc-progress-child-1").classList.remove("active"),
          e.querySelector(".acc-progress-child-2").classList.add("active"),
          e.querySelector(".acc-progress-child-3").classList.remove("active"))
        : "right" === i.style.textAlign &&
          (e.querySelector(".acc-progress-child-1").classList.remove("active"),
          e.querySelector(".acc-progress-child-2").classList.remove("active"),
          e.querySelector(".acc-progress-child-3").classList.add("active"));
  }
  if (
    i.classList.contains("contrast-style-0") ||
    i.classList.contains("contrast-style-1") ||
    i.classList.contains("contrast-style-2")
  ) {
    const e = document.querySelector("#contrast");
    e.classList.add("active"),
      e.querySelector(".acc-progress-parent").classList.remove("hiddenn"),
  ...
  if (
    (i.classList.contains("hide-images") &&
      document.querySelector("#hide-images").classList.add("active"),
    i.classList.contains("hide-video") &&
      document.querySelector("#hide-video").classList.add("active"),
    S.classList.contains("cursor-0") ||
      S.classList.contains("cursor-1") ||
      S.classList.contains("cursor-2"))
  ) {
    const e = document.querySelector("#change-cursor"),
      t = document.getElementById("triangle-cursor");
  ...
  n.forEach((e) => {
    e.querySelectorAll("path").forEach((t) => {
      t.style.fill = e.querySelector(".acc-child").classList.contains("active")
        ? "var(--acc_color_2)"
        : "var(--acc_color_1)";
    });
  });
