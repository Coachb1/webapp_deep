          ...
          <div className="flex pt-20 flex-col items-center justify-center text-center px-24 max-sm:px-8">
            ...
            <div>
              ...
              {renderType === "dynamic" ? (
                <>
                  {botScenarioCase === "icons_by_ai" ? (
                    <div className="max-sm:text-xs text-[#2f2323] flex flex-row max-sm:flex-col items-start max-sm:items-center gap-2 justify-start p-2 pb-4 border-b-2 border-dashed border-gray-300 max-w-[80%]">
